...
function initMap() {
  ...
  //This is the pin location function. Justin.
  var myLatLng = { lat: 40.76774891839929, lng: -111.8452572970429 };
  var myLatLng1 = { lat: 40.767761076004234, lng: -111.84523303216054 };
  var myLatLng2 = { lat: 40.767749338268175, lng: -111.84509604346437 };
  var map = new google.maps.Map(document.getElementById('map-body'), {
    zoom: 19,
    center: myLatLng, myLatLng1, myLatLng2
  });
